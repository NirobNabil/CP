...
let path_2;
let currentCoordinate = [0,0];
path_1.push(currentCoordinate);
path1.split(",").forEach(function(edge){
    let dir = edge[0];
    switch(dir){
        case 'R':
            currentCoordinate[0] += parseInt(edge.substr(1))
