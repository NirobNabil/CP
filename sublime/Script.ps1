...
$input = 'I:\CP\input.txt'
$output = 'I:\CP\output.txt'
$TimeoutTime = 5
$MaxOutputSize = 100MB
###################################################################################
...
#g++ -std=c++17 -fsanitize=address -fsanitize=undefined "$file" -D MONKE -include-pch F:\packages\msys2\clang64\include\c++\v1\bits\stdc++.h.gch
g++ -std=c++17 "$file" -D MONKE 
#g++ -std=c++17 "$file" -D MONKE
